    ...
    SampleAppMenuInterface
{
    ...
    private RelativeLayout mUILayout,mCameraFocus,mCameraContact;
    ...
    protected void onCreate(Bundle savedInstanceState)
    {
        ...
        mDatasetStrings.add("TOTORO.xml");
        ...
        runOnUiThread(new Runnable() {
            ...
            public void run() {
                new Handler().postDelayed(new Runnable() {
                    @Override
                    public void run() {
                        Toast.makeText(ImageTargets.this, text, Toast.LENGTH_SHORT).show();
                    }
                }, 1000);
            }
        });
    ...
    // Show the white focus on the frame
    public void ShowFocus (){

        LayoutInflater inflater = LayoutInflater.from(this);
        mCameraFocus = (RelativeLayout) inflater.inflate(
                R.layout.camera_focus, null, false);
        ...
        runOnUiThread(new Runnable() {
            ...
            public void run() {
                new Handler().post(new Runnable() {
                    @Override
                    public void run() {
                        if (mCameraFocus.getParent() != null) {
                            ((ViewGroup) mCameraFocus.getParent()).removeView(mCameraFocus);
                        }
                        addContentView(mCameraFocus, new LayoutParams(LayoutParams.MATCH_PARENT,
                                LayoutParams.MATCH_PARENT));
                    }
                });
    ...
    //If detect any trackables , show the blue focus on the frame
    public void ShowFocusContact(){

        LayoutInflater inflater = LayoutInflater.from(this);
        mCameraContact = (RelativeLayout) inflater.inflate(R.layout.camera_contact,null,false);
                ...
                public void run() {
                    new Handler().post(new Runnable() {
                        ...
                        public void run() {
                            ...
                            if (mCameraContact.getParent() != null) {
                                ((ViewGroup) mCameraContact.getParent()).removeView(mCameraContact);
                            }
                            addContentView(mCameraContact, new LayoutParams(LayoutParams.MATCH_PARENT,
                                    LayoutParams.MATCH_PARENT));
                        }
                    });
