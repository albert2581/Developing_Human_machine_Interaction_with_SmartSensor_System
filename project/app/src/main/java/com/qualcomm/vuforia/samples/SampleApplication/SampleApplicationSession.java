...
public class SampleApplicationSession implements UpdateCallbackInterface
{
    ...
    public void startAR(int camera) throws SampleApplicationException
    {
        ...
        if (!CameraDevice.getInstance().start())
        {
            ...
            Log.d(LOGTAG,"start Cameraaaaaaaaaaaaaaaaaaaaa");
    ...
    private class InitVuforiaTask extends AsyncTask<Void, Integer, Boolean>
    {
        ...
        protected Boolean doInBackground(Void... params)
        {
            ...
            synchronized (mShutdownLock)
            {
                ...
                //Cellphone
                Vuforia.setInitParameters(mActivity, mVuforiaFlags, "AY8fTdv/////AAAAAcOCNpxn00" +
                        "jDhLB2Y3yGAks4C/e0wP6FFIKR2lEN/uH26kE/KuhalS1uZVXRO5JsnBdJX5" +
                        "UnZBwqUkZihnUqEMKeoSM73GvWuHLzdCOjhltklfmPQ1ZxSxRyt7pz2R1ZB" +
                        "Y2XqfVn1eEv6pDNX90elnCQs75FY10FpAyF4zJh8uVOxZZ+miy+BA2Xc5wSiY" +
                        "DmDvStCSqQNtOvqKKHQRPPpsjVeU7D9MRLzlFV8Ynoclm7OV8DKgEiqbkLaV" +
                        "7OUQ4DcBsEPvMX2h3r/W6iGgn7oxpVQhqbF4gW8Hq0rJOhURbGHFEKxN2/Z" +
                        "EKjlkkz5giyv1WMzJD9j8edUyuUddYz5ICdqMjP4r9bP4tQinB4/Pf0");

                // Eyewear
//                Vuforia.setInitParameters(mActivity, mVuforiaFlags,"");
